 ...
 * @author Saatvik
 */
public class Insert_quiz extends javax.swing.JFrame {

    /**
     * Creates new form Insert_quiz
     */
    public Insert_quiz() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("ENTER THE OPTIONS ");
...
catch(Exception e)
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Insert_quiz.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Insert_quiz().setVisible(true);
            }
        });
    }
