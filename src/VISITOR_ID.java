 ...
 * @author Saatvik
 */
public class VISITOR_ID extends javax.swing.JFrame {

    /**
     * Creates new form VISITOR_ID
     */
    public VISITOR_ID() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VISITOR_ID.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VISITOR_ID().setVisible(true);
            }
        });
    }
